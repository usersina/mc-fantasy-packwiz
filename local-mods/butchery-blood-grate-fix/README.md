...
Companion Paxi recipes let an Iron's Spells Alchemist Cauldron transfer Butchery blood without inventing or deleting fluid:

- one Blood Bucket is 1000 mB and can be emptied into or filled from the cauldron
- one Bottle of Blood is 300 mB and can be emptied into or filled from the cauldron
- one Butchery Bottle of Blood converts to a Vampirism Blood Bottle containing three blood units, also 300 mB

A bucket therefore fills three bottles and leaves 100 mB in the cauldron for the next batch.
